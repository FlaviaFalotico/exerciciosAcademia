...
{
    Console.Clear();
    Console.Write("Digite o nome do seu candidato, ou BRAMCO, ou FIM para encerrar: ");
...
Console.WriteLine("Total de votos para em BRANCO: " + totalVotosBranco);