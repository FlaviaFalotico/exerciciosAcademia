...
float tamanhoArea, quantidadeTinta, valorTotal, sobraTinta;
int quantidadeLatas;

Console.Write("Informe o tamanho da área a ser pintada: ");
tamanhoArea = float.Parse(Console.ReadLine());
...
Console.WriteLine();
Console.WriteLine("A quantidade de tinta necessária para cobrir a área de " + tamanhoArea.ToString("F1") + "m² é de: " + quantidadeTinta.ToString("F1") + " litros.");
Console.WriteLine();
Console.WriteLine("A quantidade de latas de 18 litros para cobrir a área de " + tamanhoArea.ToString("F1") + "m² é de: " + quantidadeLatas + " latas.");
Console.WriteLine();
Console.WriteLine("O valor total a ser gasto é de: R$ " + valorTotal.ToString("F2") + ".");
Console.WriteLine();
