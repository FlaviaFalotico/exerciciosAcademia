/*
5-) Programa em VS que recebe e-mails de um usuário e que são gravados em arquvo.
*/
...
do
{
    ...
    switch (opcao)
    {
        case "1":
            ...
            {
                string email, nome;
                Console.Write("Digite o nome: ");//colocar na lista primeiro para fazer as verificações
